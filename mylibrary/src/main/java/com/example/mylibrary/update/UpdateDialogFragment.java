...
import com.example.mylibrary.update.listener.ExceptionHandler;
import com.example.mylibrary.update.listener.ExceptionHandlerHelper;
import com.example.mylibrary.update.listener.IUpdateDialogFragmentListener;
import com.example.mylibrary.update.service.DownloadService;
import com.example.mylibrary.update.util.AppUpdateUtils;
import com.example.mylibrary.update.view.NumberProgressBar;
import com.example.mylibrary.utils.ColorUtil;
import com.example.mylibrary.utils.DrawableProvider;
...
//                });
    ...
    private void setDialogTheme(int color, int topResId) {
        ...
        mUpdateOkButton.setBackgroundDrawable(DrawableProvider.getDrawable(AppUpdateUtils.dip2px(4, getActivity()), color));
