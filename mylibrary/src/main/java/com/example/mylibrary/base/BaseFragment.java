...
import com.example.mylibrary.itegretion.lifecycle.FragmentLifecycleable;
import com.example.mylibrary.mvp.IPresenter;
...
public abstract class BaseFragment<P extends IPresenter> extends SupportFragment implements IFragment, FragmentLifecycleable {
    ...
    public synchronized Cache<String, Object> provideCache() {
        if (mCache == null) {
            mCache = CommonUtils.obtainAppComponentFromContext(getActivity()).cacheFactory().build(CacheType.FRAGMENT_CACHE);
        }
        return mCache;
    }
