 ...
 */
package com.example.mylibrary.net.http.imageloader.glide;
...
import com.example.mylibrary.net.http.OkHttpUrlLoader;
import com.example.mylibrary.net.http.imageloader.BaseImageLoaderStrategy;
import com.example.mylibrary.utils.CommonUtils;
import com.example.mylibrary.utils.DataHelper;
...
public class GlideConfiguration extends AppGlideModule {
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlideBuilder builder) {
        final AppComponent appComponent = CommonUtils.obtainAppComponentFromContext(context);
    ...
    public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
        ...
        AppComponent appComponent = CommonUtils.obtainAppComponentFromContext(context);
